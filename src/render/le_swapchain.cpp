...
namespace le {
    ...
    LeSwapchain::LeSwapchain(LeDevice& deviceRef, VkExtent2D extent)
        : device{ deviceRef }, windowExtent{ extent } {
        init();
    }
    
    LeSwapchain::LeSwapchain(LeDevice& deviceRef, VkExtent2D extent, std::shared_ptr<LeSwapchain> previous)
        : device{ deviceRef }, windowExtent{ extent }, oldSwapchain{ previous } {
        init();

        //clean up old swpa chain
        oldSwapchain = nullptr;
    }

    void LeSwapchain::init()
    {
        createSwapchain();
        createImageViews();
        createRenderPass();
    ...
    VkResult LeSwapchain::acquireNextImage(uint32_t* imageIndex) {
        vkWaitForFences(
            device.device(),
            1,
    ...
    VkResult LeSwapchain::submitCommandBuffers(
    ...
    void LeSwapchain::createSwapchain() {
    ...
    void LeSwapchain::createImageViews() {
    ...
    void LeSwapchain::createRenderPass() {
    ...
    void LeSwapchain::createFramebuffers() {
    ...
    void LeSwapchain::createDepthResources() {
    ...
    VkSurfaceFormatKHR LeSwapchain::chooseSwapSurfaceFormat(
    ...
    VkFormat LeSwapchain::findDepthFormat() {
